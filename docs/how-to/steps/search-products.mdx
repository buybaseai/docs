      ...
      ```jsx
        ...
        function Conversation() {
          ...
          const handleUserMessage = async (data) => {
            ...
            // Check for tool call and fetch search results if present
          ...
          const getChatCompletion = async (message) => {
            ...
            // This function should return the tool call response
            return {
              tool_calls: [
                {
                  function: {
                    name: 'search_tool',
                    arguments: "{'q':'nike running shoes', 'platform':'amazon'}",
                  },
                },
              ],
            };
          ...
          const fetchSearchResults = async (searchParams) => {
            // Simulate fetching search results from Buybase
            const response = await fetch(`https://api.buybase.ai/search?q=${searchParams.q}&platform=${searchParams.platform}`);
            if (!response.ok) {
